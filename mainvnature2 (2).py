...
class EndGame(QMainWindow):
    def __init__(self, scr, gmvr):
        ...
        res.setGeometry(screen_width // 2 - 200, screen_height // 2 - 400, 800, 300)
        ...
        score_l.setGeometry(screen_width // 2 - 200, screen_height // 2 - 100, 500, 300)
        ...
        start_button.setGeometry(screen_width // 2 - 50, screen_height // 2 + 200, 300, 100)
...
class GameWindow(QMainWindow):
    ...
    def setupMediaPlayer(self):
        ...
        url = QUrl.fromLocalFile("123.mp3")
