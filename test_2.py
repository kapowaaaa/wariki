    ...
    def __init__(self):
        ...
        for i in range(total_rows):
            ...
            for j in range(column):
                color = (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255))  # Генерация случайного RGB-цвета
        ...
        for ball in balls_field:
            ...
            rgb_color = f"rgb({color[0]}, {color[1]}, {color[2]})"  # Формирование строки RGB-цвета
            ball_label.setStyleSheet(f"background-color: {rgb_color}; "
